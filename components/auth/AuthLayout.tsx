  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(160deg,#f8fbff_0%,#eef4ff_42%,#f7f1e8_100%)] px-4 py-10 dark:bg-[linear-gradient(180deg,#09111d_0%,#0f1728_56%,#111826_100%)]">
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-5rem)] w-full max-w-6xl items-center gap-8 pt-14 lg:grid-cols-[minmax(0,1.05fr)_1px_minmax(0,0.95fr)] lg:gap-10 lg:pt-0">
        <section className="hidden min-h-[620px] flex-col justify-between py-10 lg:flex">
          <div className="space-y-10 pr-10">
            <div className="flex items-center gap-4">
              <div className="flex size-14 items-center justify-center rounded-[1.35rem] border border-white/70 bg-white/80 shadow-sm dark:border-white/10 dark:bg-white/8">
                <Image
                  src={siteConfig.logo}
                  alt="Kochat logo"
                  width={34}
            ...
            <div className="space-y-4">
              <p className="max-w-xl text-5xl font-semibold leading-[1.02] tracking-[-0.04em] text-balance">
                {asideTitle}
              </p>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {asideItems.map((item) => (
              <div
                key={item.title}
                className="rounded-[1.55rem] border border-black/6 bg-white/72 p-4 backdrop-blur dark:border-white/10 dark:bg-white/6"
              >
        ...
        <div className="hidden h-[72%] w-px rounded-full bg-[linear-gradient(180deg,transparent,rgba(15,23,42,0.14),transparent)] lg:block dark:bg-[linear-gradient(180deg,transparent,rgba(255,255,255,0.12),transparent)]" />
        ...
        <section className="mx-auto w-full max-w-[480px] lg:max-w-none">
          <div className="space-y-8 rounded-[2rem] border border-white/65 bg-white/76 p-6 shadow-[0_24px_90px_rgba(57,77,118,0.12)] backdrop-blur dark:border-white/10 dark:bg-[rgba(10,16,28,0.78)] dark:shadow-[0_24px_90px_rgba(0,0,0,0.28)] sm:p-8">
            <div className="flex items-center gap-3 lg:hidden">
              <div className="flex size-12 items-center justify-center rounded-2xl border border-white/70 bg-white/85 shadow-sm dark:border-white/10 dark:bg-white/8">
                <Image
                  src={siteConfig.logo}
                  alt="Kochat logo"
                  width={30}
